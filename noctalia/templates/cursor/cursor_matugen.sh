...
COLORS_FILE="$HOME/.config/noctalia/templates/cursor/colors_filled.json"
...
# --- Detect whether niri is installed ------------------------------------
...
if is_niri_installed; then
cat <<EOF > "$HOME/.config/niri/bibata_cursor.kdl"
cursor {
